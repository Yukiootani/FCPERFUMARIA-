...
messaging.onBackgroundMessage((payload) => {
  ...
  const notificationOptions = {
    ...
    icon: 'https://cdn-icons-png.flaticon.com/512/2771/2771401.png', // Ícone Novo
    
    // 🚨 TRUQUE DO 3 MARIAS (VIBRAÇÃO FORÇADA) 🚨
    tag: 'push-alert-' + Date.now(), // Tag única para não agrupar
